...
>(({ className, ...props }, ref) => (
  <h5 ref={ref} className={cn("mb-2 font-medium text-base leading-6 tracking-normal", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("text-sm font-normal leading-6", className)} {...props} />
))
